...
export default function FeatureCard({ item }: { item: Feature }) {
  ...
  return (
    <div className="bg-white border-2 border-[#DAF866] gap-6 m-3 p-6 w-full h-full flex flex-col items-center lg:items-start text-center rounded-md shadow-md">
      <div className="w-20 h-20 bg-[#dbf575c0] flex items-center justify-center rounded-lg mb-4">
        <Icon className="text-[#819C22] w-15 h-8" />
      </div>
